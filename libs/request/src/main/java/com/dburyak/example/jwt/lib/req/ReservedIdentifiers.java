...
public class ReservedIdentifiers {
    ...
    public static final UUID TENANT_SERVICE_USER_UUID = UUID.fromString("00000000-0000-0000-0000-000000000002");
    ...
    public static final UUID SERVICE_TENANT_UUID = UUID.fromString("00000000-0000-0000-0000-000000000000");
    public static final UUID SA_TENANT_UUID = UUID.fromString("00000000-0000-0000-0000-000000000001");
