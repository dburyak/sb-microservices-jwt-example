...
public class JwtServiceTokenManager implements ServiceTokenManager {
    ...
    public JwtServiceTokenManager(JwtAuthProperties props, JwtGenerator jwtGenerator, String serviceName) {
