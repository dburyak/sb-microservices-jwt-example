...
@ChangeUnit(id = "0008-insert-email-service-user", order = "0008", author = "dmytro.buryak")
public class M_0008_InsertEmailServiceUser {
    static final UUID EMAIL_SERVICE_USER_UUID = UUID.fromString("00000000-0000-0000-0000-000000000005");
    static final String DISPLAY_NAME = "email-service user";
    static final String EMAIL = "email.service@jwt.example.dburyak.com";
    ...
    public void execute(MongoDatabase mongo) {
        ...
        collection.insertOne(new Document(Map.ofEntries(
                ...
                entry(FIELD_UUID, EMAIL_SERVICE_USER_UUID),
