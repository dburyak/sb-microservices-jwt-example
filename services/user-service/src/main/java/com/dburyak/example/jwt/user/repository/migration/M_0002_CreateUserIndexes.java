...
public class M_0002_CreateUserIndexes {
    ...
    static final String IDX_EMAIL_1_TENANT_UUID_1 = "email_1_tenantUuid_1";
    ...
    public void executeBeforeWithoutTx(MongoDatabase mongo) {
        ...
        collection.createIndex(new Document(Map.of(FIELD_EMAIL, 1, FIELD_TENANT_UUID, 1)),
                new IndexOptions().name(IDX_EMAIL_1_TENANT_UUID_1).unique(true));
    }
    ...
    public void rollbackBeforeExecution(MongoDatabase mongo) {
        ...
        collection.dropIndex(IDX_EMAIL_1_TENANT_UUID_1);
    }
