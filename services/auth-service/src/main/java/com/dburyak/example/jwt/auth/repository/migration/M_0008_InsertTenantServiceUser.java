...
@ChangeUnit(id = "0008-insert-tenant-service-user", order = "0008", author = "dmytro.buryak")
public class M_0008_InsertTenantServiceUser {
    static final String USERNAME = "tenant-service";
    ...
    public void execute(MongoDatabase mongo) {
        ...
        userMap.put(FIELD_UUID, TENANT_SERVICE_USER_UUID);
